...
cast_away = media.Movie(
                        "Cast away",
                        "The film depicts a FedEx employee
...
interstellar = media.Movie(
                           ...
                           a wormhole in space in an attempt to
...
walle = media.Movie(
                    ...
                    robot inadvertently embarks on a space journey that
...
udaan = media.Movie(
                    "Udaan",
                    "Expelled from his school, a 16-year
                    old boy returns home to his abusive and oppressive father",
...
doctor_strange = media.Movie(
                             "Doctor Strange",
                             "A former neurosurgeon embarks on
                             a journey of healing only to be drawn into
...
# creating udaan movie instance from Movie Class
star_trek_beyond = media.Movie(
                               "Star Trek Beyond",
                               "The USS Enterprise crew explores the
                               furthest reaches of uncharted space
                               where they encounter a
                               new ruthless enemy who puts them and
...
deadpool = media.Movie(
                       ...
                       of humor is subjected to a rogue experiment that leaves
                       him with accelerated healing powers and
                       a quest for revenge.",
...
movies = [
    cast_away, avatar, interstellar,
    walle, udaan, doctor_strange,
    star_trek_beyond, deadpool, arrival]
